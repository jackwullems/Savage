...
const HomePageTemplate = ({
  ...
  testimonials,
    ...
    useEffect(() => {
        ...
        // .setClassToggle('#free-consultion', 'fixed')
        // .on('leave', ()=>{
        //     console.log('--------------------------------------')
        //     setCOnsultionFixed(consultionFixed=>{
        //         if (consultionFixed) {
        //             return false
        //         } else {
        //             return true
    ...
    const [consultionFixed, setCOnsultionFixed] = useState(false)
    return (
    <div>
      <Helmet>
        ...
        <p className='vertical-left fixed-10 left-10'>
            We are extension of your business
        </p>
        <p className='vertical-right underline fixed-10 right-10'>
            Scroll
        </p>
      ...
      <div className='section flex-column' id='section2'>
        ...
        <a id='free-consultion' className={consultionFixed?'fixed vertical-left-banner':'vertical-left-banner'}>
            I Want Free Consultion
        </a>
        <p className='valu scroll-right2'>VALU</p>
      </div>
          ...
          <div className='tile is-ancestor'>
            ...
            <div className='tile is-7 is-vertical'>
              <div className='tile left-hightlight10 opacity-black padding-0'>
                <div className='tile is-4 has-padding-left-10'>
      ...
      <section className='section'>
        <div className='has-text-centered'>
            <img src={savageLogo} width='40' id='savage-logo'/>
