    ...
    <div>
      ...
      <div className='section' id='section1'>
        <div className='tile is-ancestor'>
          <div className='tile is-1 scrollDown1 align-center flex-row justify-center'>
            <p className='vertical-left'>
              We are extension of your business
            </p>
          </div>
          <div className='tile is-7 scroll-right1 align-center flex-row'>
            <p className='font-150 margin-vertical-auto'>
              Audacious<br />Marketing,<br /><b className='font-150-bold'>Savage<br />Results</b>
            </p>
          </div>
          <div className='tile is-3 align-items-center flex-row'>
            <a className='font-32 squrebracket'>
              Call Now
            </a>
          </div>
          <div className='tile is-1 scrollDown1 align-items-center flex-row'>
            <p className='vertical-right underline'>
              Scroll
            </p>
          </div>
        </div>
