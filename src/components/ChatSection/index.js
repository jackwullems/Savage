        ...
        <section className='section has-margin-top-100' id='sectionChat'>
            <div className='has-text-centered'>
                ...
                </div>
                {
                    ...
                    <svg  width="560px" height="250px" viewBox="0 0 212 51" version="1.1" xmlns="http://www.w3.org/2000/svg" style={{fillRule: 'evenodd', clipRule: 'evenodd', strokeLinejoin: 'round', strokeMiterlimit: 2}}>
